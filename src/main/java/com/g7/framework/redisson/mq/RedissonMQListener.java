package com.g7.framework.redisson.mq;

import com.g7.framework.redisson.annotation.MQConsumer;
...
public class RedissonMQListener implements BeanPostProcessor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RedissonMQListener.class);
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ReflectionUtils.doWithMethods(bean.getClass(), method -> {
            MQConsumer annotation = AnnotationUtils.findAnnotation(method, MQConsumer.class);
            if (annotation != null) {
