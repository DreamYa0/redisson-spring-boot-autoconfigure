package com.g7.framework.redisson.properties;


import com.g7.framework.redisson.enums.LockModel;
import com.g7.framework.redisson.enums.Model;
...
public class RedissonProperties {
    ...
    //数据缓存时间 默认永久
    private Long dataValidTime = -1L;
    //结束
    @NestedConfigurationProperty
    private SingleServerConfig single;
    @NestedConfigurationProperty
    private MultipleServerConfig multiple;
    ...
    public MultipleServerConfig getMultiple() {
        return multiple;
    }

    public void setMultiple(MultipleServerConfig multiple) {
