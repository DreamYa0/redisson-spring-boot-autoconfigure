...
import com.g7.framework.redisson.aop.LockAop;
import com.g7.framework.redisson.aop.MQAop;
import com.g7.framework.redisson.operation.RedissonObjectWrapper;
import com.g7.framework.redisson.operation.RedissonBinary;
import com.g7.framework.redisson.operation.RedissonCollection;
import com.g7.framework.redisson.operation.RedissonObject;
import com.g7.framework.redisson.properties.MultipleServerConfig;
import com.g7.framework.redisson.properties.RedissonProperties;
import com.g7.framework.redisson.proxy.RedissonClientProxy;
...
public class RedissonConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean(RedissonObjectWrapper.class)
    public RedissonObjectWrapper redissonObjectWrapper(@Autowired RedissonObject redissonObject) {
        return new RedissonObjectWrapper(redissonObject);
    }
    ...
    public RedissonClient redissonClient() {
        ...
        MultipleServerConfig multipleServerConfig = redissonProperties.getMultiple();

        switch (redissonProperties.getModel()) {
            case SINGLE:
                SingleServerConfig singleServerConfig = config.useSingleServer();
                com.g7.framework.redisson.properties.SingleServerConfig param = redissonProperties.getSingle();
    ...
    private  <T> T proxy(T target) {
        RedissonClientProxy aspect = new RedissonClientProxy(target);
        return (T) Proxy.newProxyInstance(target.getClass().getClassLoader(), target.getClass().getInterfaces(), aspect);
    }
